...
$headstuff .= "    let vals=[];\n";
$headstuff .= "    \$(\"#".$internalfield."_input_form\").find(\":input\").each(function(){\n";
$headstuff .= "      let o={};\n";
...
if ($internalfield eq "dhcp_vendorclass") {
    ...
    print &ui_columns_row( [ $text{"p_label_val_set_tag"} . "  ", &ui_textbox("new_tag", undef, 5) ], \@tds );
...
elsif ($internalfield eq "dns_servers") {
