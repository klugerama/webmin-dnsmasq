#!/usr/bin/perl
#
#    DNSMasq Webmin Module - # TODO xiface_edit_apply.cgi; do the update      
...
#
my $line="except-interface=".$in{"interface"};
&update( $dnsmconfig{"except-interface"}[$in{idx}]{"line"}, $line,
